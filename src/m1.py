...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.ogcolor = self.circle.fill_color
        self.colors = colors
        self.run = 0
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        r = random.randrange(0,len(self.colors))
        self.circle.fill_color = self.colors[r]
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        dist = self.circle.center.get_distance_from(other_circle_changer.circle.center)
        radius = dist/2
        circle = CircleChanger((self.circle.center.x + other_circle_changer.circle.center.x) / 2,
                                    (self.circle.center.y + other_circle_changer.circle.center.y) / 2, radius, 'red',
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.ogcolor
    ...
    def change_to_next_color_in_tuple(self):
        ...
        self.circle.fill_color = self.colors[self.run % len(self.colors)]
        self.run = self.run + 1
